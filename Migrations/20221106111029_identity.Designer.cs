...
namespace bookstore.Migrations
{
    ...
    [Migration("20221106111029_identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("bookstore.Auth.Model.BookstoreUser", b =>
                {
            ...
            modelBuilder.Entity("bookstore.Data.Entities.Author", b =>
                {
                    ...
                    b.HasOne("bookstore.Auth.Model.BookstoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("bookstore.Auth.Model.BookstoreUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
